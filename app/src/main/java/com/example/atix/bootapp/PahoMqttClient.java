...
public class PahoMqttClient {
    ...
    private MqttConnectOptions getMqttConnectionOption() {
        ...
        mqttConnectOptions.setWill(Constants.PUBLISH_TOPIC, "I am going offline".getBytes(), 0, true);
        mqttConnectOptions.setUserName(Constants.CLIENT_ID);
    ...
    public void publishMessage(@NonNull MqttAndroidClient client, @NonNull String msg, int qos, @NonNull String topic)
        ...
        //Log.d(TAG,"End of publishMessage" + message.getPayload().toString());
    }
